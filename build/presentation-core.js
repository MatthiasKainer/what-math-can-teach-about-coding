...
let PresentationCore = class PresentationCore extends LitElement {
    constructor() {
        super(...arguments);
        this.pathsTo = {
            first: '7:2',
    ...
    path.push(current)
      ...
      <presentation-page>
        ...
        <hexagon-container 
          ...
          @select="${(e) => {
            this.pathsTo.first = e.detail.hexagon.cube
                .toPosition()
                .toString();
            this.requestUpdate();
            e.preventDefault();
      ...
      <presentation-page>
        ...
        ></hexagon-container>
        <input type="checkbox" @click="${() => ((this.pathsTo.second.ignoreObstacle = !this.pathsTo.second
            .ignoreObstacle),
            this.requestUpdate())}" /> Comply to reality
      </presentation-page>
      <presentation-page>
