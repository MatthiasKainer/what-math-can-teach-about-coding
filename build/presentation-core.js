...
export default pureLit('presentation-core', (element) => html `
    <presentation-body>
  ...
  while (!current.equals(goal)) {
    ...
    path.push(current)
      ...
      <presentation-slide>
        ...
        <hexagon-container 
          coordinates="even-q" 
          rows="4" cols="7"  label="cube-distance" .selectDefault=${"0:0"} .pathFrom=${"0:0"} .pathTo="${pathsTo.first}" .showPath=${"taxicab"}
          @select="${(e) => {
    pathsTo.first = e.detail.hexagon.cube
        .toPosition()
        .toString();
    ...
    e.preventDefault();
      ...
      <presentation-slide>
        ...
        <hexagon-container 
          ...
          .selectDefault=${"0:0"} .pathFrom=${"0:0"} .pathTo="${pathsTo.second.target}" .showPath=${"taxicab"}
    ...
    e.preventDefault();
        ...
        ></hexagon-container>
        <input type="checkbox" @click="${() => ((pathsTo.second.ignoreObstacle = !pathsTo.second.ignoreObstacle),
    element.requestUpdate())}" /> Check me to make the path comply to reality
      </presentation-slide>
      <presentation-slide>
    ...
    for (const next of neverVisitedNeighbors(current)) {
      ...
      <presentation-slide>
        ...
        <hexagon-container 
          ...
          .selectDefault=${"0:0"} .pathFrom=${"0:0"} .pathTo="${pathsTo.fourth.target}"
          .blocked="${['4:0', '4:1', '4:2', '4:3']}"
        ></hexagon-container>
        <button @click="${() => {
    ...
    for (const next of neverVisitedNeighbors(current)) {
      ...
      <presentation-slide>
        ...
        <hexagon-container 
          ...
          .selectDefault=${"0:0"} .pathFrom=${"0:0"} .pathTo="${pathsTo.fifth.target}" .showPath=${"taxicab"}
          .blocked="${['3:3', '3:4', '3:5']}"
          .expensive="${[
    '4:0',
    '4:2',
...
//# sourceMappingURL=presentation-core.js.map